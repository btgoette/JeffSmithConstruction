module.exports = {
  ...
  exportPathMap: async function (defaultPathMap) {
    return {
      ...
      "/forms/endocrine-steam-intake": {
        page: "/forms/endocrine-steam-intake",
      },
      "/forms/covid-19": { page: "/forms/covid-19" },
      "/forms/pediatric-assessment-questionnaire": {
        page: "/forms/pediatric-assessment-questionnaire",
      },
      "/policies/privacy-policy": { page: "/policies/privacy-policy" },
      "/policies/cookie-policy": { page: "/policies/cookie-policy" },
      "/policies/cancellation-rescheduling-policy": {
        page: "/policies/cancellation-rescheduling-policy",
      },
      "/services/index": { page: "/services" },
      "/services/high-frequency-endocrine-steam": {
        page: "/services/high-frequency-endocrine-steam",
      },
      ...
      "/kids/conditions/index": { page: "/kids/conditions" },
      "/kids/conditions/digestive-system": {
        page: "/kids/conditions/digestive-system",
      },
      "/kids/services/index": { page: "/kids/services" },
      ...
      "/conditions/stress-and-adrenal-function": {
        page: "/conditions/stress-and-adrenal-function",
      },
